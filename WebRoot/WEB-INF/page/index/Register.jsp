					...
					<form action="user_reg.action" method="post">
						...
						<div class="line">
							<div class="other-div">
								...
								<div class="x9">
									<input type="password" name="confirmpassword" id="" placeholder="请再次输入密码" maxlength="15"/>
								</div>
							</div>
						</div>
						<div class="line">
							<div class="other-div">
								...
								<div class="x6">
									<input type="text" name="code" id="code" placeholder="请输入验证码" maxlength="4"/ onblur="yanzheng();">
								</div>
								<div class="x3">
...
<!-- 		<div class="container-layout">
			<div class="padding-top">
				...
				<div class="text-center height-big" style="background: #0ae">
					版权所有 © 胖虎二手商城
				</div>
			</div>
		</div>
